        ...
        def get_ge_shared_and_unique_parts( num_bottom_layers, output_model_type, full_model_weight_path=None, input_tensor=None):
            ...
            if full_model_weight_path:
                ...
                if 'media' in os.path.dirname(os.path.abspath(__file__)):
                    model.load_weights(
                        '/media/hdddati2/bzhang/trained_models/gtsrb/surrogate_VGG16_Dec23/output_replaced_with_dense_for_bit_model.hdf5')
                else:
                    model.load_weights(
                        'G:/bowen/gtsrb/surrogate_VGG16_Dec23/output_replaced_with_dense_for_bit_model.hdf5')
